...
$msgcancel= "Movie Hub...".$_POST[msgcancel];
//echo $mailmsgcancel = $_POST[mailmsgcancel];
sendmail($rscustomer[emailid],"Ticket cancel Receipt..",$msgcancel,"Movie Hub...")

?>
<iframe id="contact" src="http://smsc.co.in/api/mt/SendSMS?APIKey=04024e1f-2d50-4874-b1b5-b1b1d901e928&senderid=TESTIN&channel=2&DCS=0&flashsms=0&number=91<?php echo $rscustomer[contactno]; ?>&text=<?php echo $msgcancel; ?>&route=1" allowtransparency="true" frameborder="0" scrolling="yes" style="visibility:Hidden;"></iframe>
<?php	
...
<?php							
$mailmsgcancel  =  "<b><center>movietime</center></b><br>";
$mailmsgcancel  = "<b>.your movie ticket has been cancelled</b><br>";
$mailmsgcancel = "<br>". $mailmsg. " Amount - ".$paidamt;
$mailmsgcancel = "<br>". $mailmsgcancel. "paid amount(Excluding booking fee and tax) : ".$paidamt;
$mailmsgcancel  = "<br>". $mailmsgcancel. "Cancellation Charge (50%): " .$cantotamt/2 .".. ";
$mailmsgcancel  = "<br>". "<br>". $mailmsgcancel . "Refundable amount: " .$cantotamt/2 .".. ";
$mailmsgcancel  = "<b>. Amount will be refunded in 2-3 working days...</b><br>";

$msgcancel= "<b>.your movie ticket has been cancelled </b><br>";
$msgcancel =  $msgcancel. "paid amount(Excluding booking fee and tax) : ".$paidamt.".. ";
$msgcancel  = $msgcancel . "cancellation charge : " .$cantotamt/2 .".. ";
$msgcancel =  $msgcancel . "Refundable amount: " .$cantotamt/2 .".. ";
$msgcancel= "<b>. Amount will be refunded in 2-3 working days...</b><br>";

?>
	<input type='hidden' name="msgcancel" value="<?php echo $msgcancel; ?>" />	
<input type='hidden' name="mailmsgcancel" value="<?php echo $mailmsgcancel; ?>" />	
...
function validateform()
{
	...
	if(!document.cancelfrm.bankname.value.match(alpha))
	{
		document.getElementById("idbankname").innerHTML="bank name should contain only alphabets..";		
		i=1;
	}
