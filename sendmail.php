...
function sendmail($toaddress,$subject,$message,$name)
{
	...
	$mail->From = 'moviehub@technopulse.in';
	$mail->FromName = 'MovieHub';
	$mail->addAddress($toaddress, $name);     // Add a recipient
	$mail->addAddress($toaddress);               // Name is optional
	$mail->addReplyTo('hardiksalian98@gmail.com', 'MovieHub');
	$mail->addCC('hardiksalian98@gmail.com');
	$mail->addBCC('hardiksalian98@gmail.com');
