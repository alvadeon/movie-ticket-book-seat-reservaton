...
if(isset($_GET[id]))
{
	echo "<script>window.location='theatrerecoverpassword.php?id=$_GET[id]';</script>";
}
if(isset($_POST[submit]))
{
	$sql = "SELECT * FROM theatre WHERE emailid='$_POST[email]' ";
	...
	if(mysqli_num_rows($qsql)==1)
	{
		...
		sendmail($rs[emailid],"MovieTime - Password Recovery Mail",$msg,$rs[customername]);
...
<tr><td colspan="2"><div align="center"><input type="submit" value="Submit.." id="submit" name="submit" class="btn btn-primary btn-lg" /></div></td></tr>
