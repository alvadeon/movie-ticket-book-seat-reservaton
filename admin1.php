...
function validateform()
{
	...
	if(document.frmadmin.adminname.value!="" && document.frmadmin.adminname.value.match(num))
	{
		document.getElementById("idadminname").innerHTML="name should not contain number..!";		
		i=1;
	}
	...
	{
		document.getElementById("idpassword").innerHTML="please enter your password...";
		i=1;
	}
